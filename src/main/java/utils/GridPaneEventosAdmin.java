...
import views.EventoAdminController;

public class GridPaneEventosAdmin {
  ...
  public List<AnchorPane> crearPaneles(List<Evento> eventosList) throws IOException {
    ...
    for (int i = 0; i < eventosList.size(); i++) {
      FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/EventoAdmin.fxml"));
      AnchorPane root = loader.load();
      EventoAdminController controlador = loader.getController();
